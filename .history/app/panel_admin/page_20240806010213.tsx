      ...
      <div className="mx-auto grid max-w-screen-xl px-4 py-8 text-center lg:py-16">
        <div className="mx-auto place-self-center">
          ...
          <p className="mb-6 max-w-2xl font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
            ...
            - <span style={{textDecoration: "line-through"}}></span>Verifier les routes et les fichiers correspondants <br />
          ...
          <object type="image/svg" data="../../graph.svg" width="500" height="100" className="mx-auto" />
      </div>
    </section>
    <section className="bg-blue-100 dark:bg-gray-900">
