...
<<<<<<<<<<<<<<  ✨ Codeium Command 🌟 >>>>>>>>>>>>>>>>
          <object type="image/svg+xml" data="../../graph.svg" width="400" height="400" alt="graph" className="mx-auto" />
          <Image src="../../graph.svg" width="400" height="400" alt="graph" className="mx-auto" />
<<<<<<<  75fe2823-113e-4016-bcf3-d45085563733  >>>>>>>
      </div>
    </section>
    <section className="bg-blue-100 dark:bg-gray-900">
