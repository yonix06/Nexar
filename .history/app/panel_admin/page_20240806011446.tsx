    ...
    <section className="bg-blue-100 dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        <div className="justify-center space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center"> ReadMe
              
              <h3 className="mb-2 text-xl font-bold dark:text-white">ReadMe</h3>
              <p className="text-gray-500 dark:text-gray-400">Readme.contenu</p>
            </div>
        </div>
      </div>
    </section>
