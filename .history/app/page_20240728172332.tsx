    ...
    images: [
      {
        ...
        pathToFileURL: "/public/img/Logo-4.png",
      },
    ],
  },
}
      ...
      <section className="bg-blue-100 dark:bg-gray-900">
        <div className="mx-auto grid max-w-screen-xl px-4 py-8 text-center lg:py-16">
          <div className="mx-auto place-self-center">
            ...
            WIP: <Images pathToFileURL="/../public/img/Logo-4.png" width={200} height={200} /> <br /> Application de gestion: Arrêtés Municipaux pour la ville de Saint-Jean-Cap-Ferrat
            </h1>
